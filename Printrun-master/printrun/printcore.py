...
class printcore():
    def __init__(self, port = None, baud = None, dtr=None):
        ...
        #MQTT
        self.broker_address = "pi-mqtt-server" #Update broker address
        self.client = mqtt.Client("printer")
    ...
    def disconnect(self):
        ...
        print("Send mqtt state:disconnected")
        ...
        if self.port is not None and self.baud is not None:
            ...
            if not is_serial:
                ...
                try:
                    ...
                    print("Send mqtt state:connected")
    ...
    def startprint(self, gcode, startindex = 0):
        ...
        print("Send mqtt state: printing")
        self.client.publish("inmachines/3dprinter/state","Printing", qos=1)
        print("Send mqtt startime: {}".format(str(datetime.now())))
        ...
        try:
            ...
            if self.endcb:
                try: 
                    ...
                    print("Send mqtt endtime: {}".format(str(datetime.now())))
