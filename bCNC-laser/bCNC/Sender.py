...
class Sender:
    ...
    def __init__(self):
        ...
        #Start MQTT
        self.broker_address= "broker.emqx.io" #'pi-mqtt-server' #Broker address
        self.client = mqtt.Client("Laser Cutter") #create new instance
    ...
    def load(self, filename):
        ...
        #Send MQTT file name
        self.client.publish("inmachines/lasercutter/filename",filename, qos=1)
    ...
    def open(self, device, baudrate):
        ...
        #Send MQTT state
        self.client.publish("inmachines/lasercutter/state",CNC.vars["state"], qos=1)
    ...
    def initRun(self):
        ...
        self.client.publish("inmachines/lasercutter/starttime",str(datetime.now()), qos=1)
    ...
    def jobDone(self):
        ...
        self.client.publish("inmachines/lasercutter/endtime",str(datetime.now()), qos=1)
        #Send MQTT state
        self.client.publish("inmachines/lasercutter/state","Job Done", qos=1)
    ...
    def controllerStateChange(self, state):
        ...
        #Send MQTT state
        self.client.publish("inmachines/lasercutter/state",state)
